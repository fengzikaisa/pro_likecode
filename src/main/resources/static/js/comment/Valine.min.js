        ...
        r.prototype.init = function (e) {
            ...
            try {
                var t = e.config, n = t.lang, r = t.langMode, i = t.avatar, a = t.avatarForce, l = t.avatar_cdn,
                    c = t.notify, d = t.verify, p = t.visitor, x = t.pageSize, w = t.recordIP, A = t.clazzName,
                ...
                var C = e.config.app_id || e.config.appId, L = e.config.app_key || e.config.appKey;
                if (!C || !L) throw 99;
                ...
                var R = e.config.el || null, j = u.findAll(document, R);
                ...
                var P = u.create("div", "class", "vloading"), U = u.find(e.el, ".vlist");
                e.loading = {
                    show: function (t) {
        ...
        r.prototype.Q = function (e) {
            ...
            var L = function (e, n, r) {
                var i = u.create("div", {class: "vcard", id: e.id}),
                    o = m.hide ? "" : '<img class="vimg" src="/img/favicon.jpg">',
                    s = e.get("ua") || "", l = "";
                if (s) {
                    s = d(s);
        ...
        var l = /[&<>"'`\\]/g, c = RegExp(l.source), d = /&(?:amp|lt|gt|quot|#39|#x60|#x5c);/g, u = RegExp(d.source),
            p = {
                domReady: function (e) {
                    ...
                    if (p.find(i, e + "[" + o + '="' + t + '"]')) "function" == typeof n && n(); else {
