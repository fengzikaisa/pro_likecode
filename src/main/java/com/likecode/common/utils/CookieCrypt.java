...
public class CookieCrypt {
    private static final CookieCrypt instance = new CookieCrypt();

    private CookieCrypt() {

    }

    public static CookieCrypt getInstance() {
        return instance;
    }
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        System.out.println(crypt.encryptAES(content, "tadu@Cookie@key"));
        String dcontent = crypt.encryptAES(content, "tadu@Cookie@key");
        System.out.println(crypt.decryptAES(dcontent, "tadu@Cookie@key"));
